...
const builtGames = [
  ...
  { title: "Petualangan RPG", description: "Jelajahi dunia RPG, lawan musuh & selamatkan desa!", emoji: "⚔️", href: "/games/built/petualangan-rpg", color: "purple" },
  { title: "RPG Phaser", description: "Top-down RPG dengan Phaser.js — jelajahi desa, hutan & penjara!", emoji: "🗺️", href: "/games/built/rpg-phaser", color: "teal" },
];
